...
# -*- coding: utf-8 -*-
"""
@Author: Adapted for Market77
@Contact: your_email@example.com
@File: main_semseg_market77.py
@Time: 2025/06/21
"""
import os
import argparse
...
def train(args, io):
    ...
    for epoch in range(args.epochs):
        ...
        io.cprint(f"Epoch {epoch+1}: Train Loss {avg_train_loss:.4f},"
        ...
        io.cprint(f"Epoch {epoch+1}: Val Acc {val_acc:.4f}, Val mIoU {val_miou:.4f}")
        '''
